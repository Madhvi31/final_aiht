...
if selected == 'About us':
    ...
    with col1:
        ...
        """, unsafe_allow_html=True)
        st.image("graphics/pregnancy_risk_image.jpg", caption="Empowering Safe Pregnancies")
    ...
    with col2:
        ...
        """, unsafe_allow_html=True)
        st.image("graphics/fetal_health_image.jpg", caption="AI-Assisted Healthy Beginnings")
